...
function run() {
	...
	if (ageGroup == "6-9") {
		...
		correctAnswerOne = "begin";
		correctAnswerTwo = "dinner";
		correctAnswerThree = "relationship";
		correctAnswerFour = "friday";
		correctAnswerFive = "dog";
		...
		//assign answers to variables
		correctAnswerOne = "politics";
		correctAnswerTwo = "funny";
		correctAnswerThree = "building";
		correctAnswerFour = "recycle";
		correctAnswerFive = "gameshow";
		...
		//Below is code that i tried to complete, due to the close deadline i was unable to do This. I am presenting this code to show my capability of coding in java
